            ...
            <div className="grid gap-4 max-w-md mx-auto">
              {contactData.socials.map((item, index) => (
                <a
                  ...
                  className="flex items-center justify-between gap-4 px-7 py-10 border border-white  rounded-lg shadow-lg dark:bg-gray-800 text-gray-800 dark:text-white hover:shadow-lg hover:-translate-y-1 transition-all"
